...
function drawText() {
  ...
  ctx1.font = "62px 'Arial', sans-serif";
  ctx1.textAlign = "center";
  ctx1.fillText(keyword1, W/2, H/2 - 35);
...
//   );
  ...
  let w = (c.width = window.innerWidth),
    ...
    hh = h / 2,
    opts = {
      strings_1: [["  ¡Muchas felicidades", "  amor!  "], ["   Espero que tengas", "  un buen día  "], ["Y que lo", "   disfrutemos juntos"],  ["Estarás deseando", "  ver tu regalo "], ["Ahí va..."], ["Era broma :P", " jajajaj "], ["Bueno ahora sí:"]],
...
function message(){
  window.alert("Nos lo dan a principios de Junio  😁");
}
